...
const DE_POLITICUS: HeroArchetype = {
  ...
  abilities: [
    ...
    },
    {
      ...
      range: 0,
      duration: 8,
      description: 'Alle units (vriend EN vijand) in radius 14 stoppen met vechten 8s. Randstad-units herstellen HP.',
    },
  ],
};
...
const DE_MIJNBAAS: HeroArchetype = {
  ...
  abilities: [
    {
      id: 'mijnbaas-mijnschacht-instorten',
      name: 'Mijnschacht Instorten',
      slot: AbilitySlot.Q,
      cooldown: 45,
      targetType: AbilityTargetType.SelfAoE,
      radius: 8,
      range: 0,
      duration: 4,
      description: 'AoE stun radius 8, 25 dmg + 4s stun door instortende rotsen',
    },
    {
      id: 'mijnbaas-gluck-auf',
      name: 'Gluck Auf',
      slot: AbilitySlot.W,
      cooldown: 60,
      targetType: AbilityTargetType.SelfAoE,
      ...
      range: 0,
      duration: 15,
      description: 'Buff Limburgse units in radius 12: +25% ATK, +15% armor, 15s',
    },
    {
      id: 'mijnbaas-tunnelcommando',
      name: 'Tunnelcommando',
      slot: AbilitySlot.E,
      cooldown: 90,
      targetType: AbilityTargetType.Self,
      ...
      range: 0,
      duration: 0,
      description: 'Teleporteer Mijnbaas + max 8 units in radius 6 naar een Grot. Vereist minstens 1 Grot.',
    },
  ],
};

const DE_MAASRIDDER: HeroArchetype = {
  ...
  abilities: [
    {
      id: 'maasridder-maasvloed',
      name: 'Maasvloed',
      slot: AbilitySlot.Q,
      cooldown: 30,
      targetType: AbilityTargetType.Line,
      radius: 4,          // line width
      range: 20,           // line length
      duration: 0,
      description: 'Line AoE (breedte 4, lengte 20), duwt vijanden terug + 30 dmg',
    },
    {
      id: 'maasridder-nevelgordijn',
      name: 'Nevelgordijn',
      slot: AbilitySlot.W,
      cooldown: 45,
      targetType: AbilityTargetType.SelfAoE,
      ...
      range: 0,
      duration: 15,
      description: 'Fog radius 10, 15s. Vijanden verliezen sight range. Limburgse units +20% speed.',
    },
    {
      id: 'maasridder-watergraf',
      name: 'Watergraf',
      slot: AbilitySlot.E,
      cooldown: 60,
      ...
      range: 10,
      duration: 12,
      description: 'Target locatie wordt onbegaanbaar terrein (water) voor 12s, radius 5',
    },
  ],
};
...
const DE_FRIETKONING: HeroArchetype = {
  ...
  abilities: [
    {
      id: 'frietkoning-koninklijke-portie',
      name: 'Koninklijke Portie',
      slot: AbilitySlot.Q,
      cooldown: 35,
      targetType: AbilityTargetType.SelfAoE,
      radius: 10,
      range: 0,
      duration: 12,
      description: 'AoE heal 30 HP + +15% alle stats voor allies in radius 10, 12s',
    },
    {
      id: 'frietkoning-belgisch-decreet',
      name: 'Belgisch Decreet',
      slot: AbilitySlot.W,
      cooldown: 60,
      targetType: AbilityTargetType.TargetEnemy,
      radius: 0,
      range: 8,
      duration: 10,
      description: 'Target vijandelijke unit wisselt van team voor 10s. Kost 20 Chocolade.',
    },
    {
      id: 'frietkoning-frituurfondue',
      name: 'Frituurfondue',
      slot: AbilitySlot.E,
      cooldown: 45,
      targetType: AbilityTargetType.PositionAoE,
      ...
      range: 10,
      duration: 10,
      description: 'Zone radius 6: 15 DPS aan vijanden, +5 HP/s heal allies, 10s',
    },
  ],
};
  ...
  abilities: [
    {
      ...
      range: 10,
      duration: 8,
      description: 'Target vijandelijke hero kan 8s geen abilities gebruiken (silence)',
    },
    {
      ...
      range: 0,
      duration: 15,
      description: 'Ally units in radius 8 krijgen +3 HP/s regeneratie, 15s',
    },
    {
      id: 'abdijbrouwer-dubbel-of-tripel',
      name: 'Dubbel of Tripel',
      slot: AbilitySlot.E,
      cooldown: 50,
      targetType: AbilityTargetType.Self,
      radius: 0,
      range: 0,
      duration: 15,
      description: 'Creeer 2 illusie-kopien (50% HP, 0 dmg, 15s). Vijand weet niet welke echt is.',
    },
  ],
};
...
export const HERO_ARCHETYPES: readonly HeroArchetype[] = [
  ...
  DE_MAASRIDDER,        // HeroTypeId.DeVlaaibaas = 5
