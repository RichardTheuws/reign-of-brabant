...
const UNIT_PORTRAITS: Record<number, Record<number, string>> = {
  [FactionId.Brabanders]: {
    ...
    [UnitTypeId.Heavy]: 'brabant-heavy',
    [UnitTypeId.Siege]: 'brabant-siege',
  ...
  [FactionId.Randstad]: {
    ...
    [UnitTypeId.Heavy]: 'randstad-heavy',
    [UnitTypeId.Siege]: 'randstad-siege',
  ...
  [FactionId.Limburgers]: {
    ...
    [UnitTypeId.Heavy]: 'limburg-heavy',
    [UnitTypeId.Siege]: 'limburg-siege',
  ...
  [FactionId.Belgen]: {
    ...
    [UnitTypeId.Heavy]: 'belgen-heavy',
    [UnitTypeId.Siege]: 'belgen-siege',
